...
df = paraphrase_clean_func(df_para, org_col_name='text', para_col_name='text_paraphrase', new_col_name = 'text_paraphrase_clean', min_length = 0, max_length = 500, min_semantic_similarity = 0.5, max_semantic_similarity = 0.95)
