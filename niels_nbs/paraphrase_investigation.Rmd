...
```{r}
df <- df %>% 
  select(Original, New, label, semantic_similarity, org_length, new_length, sentida_score_org, sentida_score_new)
```


```{r}
write_csv(df, "/Users/nielsaalundkrogsgaard/documents_local/NLP_exam/NLP_exam_2023/niels_nbs/niels_data/twitter_data_paraphrasings_w_other_stuff.csv")
```
